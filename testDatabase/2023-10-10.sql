...
CREATE TABLE `admins` (
  ...
  `secret_code` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Test',
...
CREATE TABLE `sys_methods` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `sys_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `is_menu` tinyint NOT NULL DEFAULT '1' COMMENT '0=hidden,1=show',
...
CREATE TABLE `sys_modules` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `group` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'app' COMMENT 'app=(none group), sys=(system setting group), repo=(report group)',
  `position` int DEFAULT NULL,
...
CREATE TABLE `sys_roles` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `status` tinyint NOT NULL DEFAULT '1' COMMENT '0=hidden,1=show',
  `permissions` json DEFAULT NULL,
  `permission_type` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Dump completed on 2023-10-10  1:24:40
